...
This section of the documentation talks about the development environment. You can find the repository [here](https://github.com/proofgeist/js-dev-environment).
