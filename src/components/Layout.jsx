...
const navigation = [
  ...
  },
  {
    ...
    links: [
      { title: 'Before you Begin', href: '/docs/before-begin' },
      {
        title: 'The In Depth Process',
        href: '/docs/indepth-process',
      },
      { title: 'Components', href: '/docs/components' },
      {
        title: 'Connecting to your FileMaker App',
        href: '/docs/connecting-to-fm',
      },
      ...
      {
        title: 'More about the Modern Development',
        href: '/docs/modern-development',
      },
    ],
  },
  ...
  },
  {
    ...
    links: [
      { title: 'Charting', href: '/docs/template-charting' },
      { title: 'DataTables', href: '/docs/template-datatables' },
    ],
  },
  // {
  //   title: 'Examples',
  ...
  // },
  {
    title: 'The Web Viewer Object',
    links: [
      {
        href: '/wv/surface-level',
        title: 'Surface Level',
      },
      {
        href: '/wv/integration',
          ...
          <article>
            {(title || section) && (
              <header className="space-y-1 mb-9">
                {section && (
                  <p className="text-sm font-medium text-yellow-500 font-display">
                    {section.title}
                  </p>
                )}
                {title && (
